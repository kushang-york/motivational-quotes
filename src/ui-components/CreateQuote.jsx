...
export default function CreateQuote(props) {
  ...
  const buttonOnClick = async () => {
    await client.graphql({
      ...
      variables: {
        input: {
          author: textFieldTwoNineSevenSixSixNineTwoTwoValue,
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "CreateQuote")}
      {...rest}
    >
      <Flex
        gap="24px"
      ...
      >
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="Thought"
            {...getOverrideProps(overrides, "Thought")}
          ></Text>
        </Flex>
        <Flex
          gap="16px"
        ...
        >
          ...
          <TextField
            ...
            height="unset"
            label="Thought"
            placeholder="An inspirational thought"
            shrink="0"
            alignSelf="stretch"
            size="default"
            isDisabled={false}
